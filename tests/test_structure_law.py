...
The ratchet is EMPTY, and that is the point: nothing here needs tolerating yet.
"""
...
MAX_LINES = 1000
SUFFIXES = (".py", ".js")
EXCLUDED_DIR_NAMES = {".venv", "venv", "node_modules", "__pycache__", ".git", "web", "dist"}
...
# `web/preview3d.min.js` is excluded by directory above: it is a BUILD ARTIFACT
# (one minified line of the whole bundle), not authored source, and splitting it
# would mean shipping several bundles for no reader's benefit.
