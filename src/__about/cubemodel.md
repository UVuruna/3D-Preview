...
A consumer supplies the WORDS, never the geometry — Watch Academy's exporter calls this with its own canon, so its terms stay in DOMY and this gadget stays content-agnostic. `DEMO_VOCABULARY` is a neutral demo that shows the structure and claims nothing.
